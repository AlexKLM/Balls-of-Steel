...
TCP_recv::TCP_recv(void)
{
	running = false;
}

TCP_recv::TCP_recv(shared_memory *shared,TCP_sender* send_thread,networking* net_thread)
{
	running = false;
...
void TCP_recv::recv_balls(string input)
{
	stringstream ss;
...
void TCP_recv::recv_ropes(string input)
{
	stringstream ss;
	ss.str(input.substr(1));
...
void TCP_recv::recv_qt(string input)
{
	stringstream ss;
	ss.str(input.substr(1));
...
void TCP_recv::recv_grid(string input)
{
	stringstream ss;
	ss.str(input.substr(1));
...
void TCP_recv::recv_lines(string input)
{
...
void TCP_recv::recv_status(string input)
{
	stringstream ss;
	ss.str(input.substr(1));
	int msglength;
...
void TCP_recv::recv_views(string input)
{
	stringstream ss;
	ss.str(input.substr(1));
...
void TCP_recv::translate_status(string &input)
{
...
void TCP_recv::translate_qt(string &input, int size)
{
...
void TCP_recv::translate_grid(string &input, int size)
{
...
void TCP_recv::translate_balls(string &input, int size)
{
	stringstream ss;
	ss.str(input);
	balls_packet pack;
...
void TCP_recv::translate_rope(string &input, int size)
{
...
void TCP_recv::translate_lines(string &input, int size)
{
...
void TCP_recv::translate_views(string &input, int size)
{
...
void TCP_recv::adjust_nettime(int input)
{
	nettime += input;
	if(nettime <=0)
	{
...
void TCP_recv::update_ropes(std::vector<rope_packet>* input)
{
	if(shared_data->Acquire())
	{
...
void TCP_recv::update_lines(std::vector<line_packet>* input)
{
...
void TCP_recv::update_grid(std::vector<grid_type>* input)
{
...
void TCP_recv::update_qt(std::vector<qt_packet>* input)
{
	if(shared_data->Acquire())
	{
...
void TCP_recv::update_views(std::vector<view>* input)
{
	if(shared_data->Acquire())
	{
