...
void ContactManifold::Add(ManifoldPoint point)
{
	...
	//{
		/*Vector2f colNormal = (m_points[collision].contactID2->GetNewPos() - m_points[collision].contactID1->GetNewPos()).normalise();
		Vector2f colPos = m_points[collision].contactID1->GetNewPos() + colNormal*m_points[collision].contactID1->GetRadius();*/

		//dist = colPos.distance(point.contactPoint);
		//if(dist < 0.01f)
		//{
		//	return;
		//}
...
void ContactManifold::Assess()
{
	...
	//	{
	//		if(m_points_line[collision].responded)
	//		{
